...
* dex:
  * improves the LDAP connector validation in Dex controller
  * Fixes an issue in dex addon which disallowed adding local users
...
* opsportal:
  * sets opsportalRBAC.allowAllAuthenticated to true
  * add RBAC support
...
Added support for kubernetes clusters on GCP
